" Fruity Color Scheme // extensively customized: 09/30/08:CBF
" ===================
"
" fruity Author:    Armin Ronacher <armin.ronacher@active-4.com>
" edited by:        Camron Flanders for personal use. <camron@camronflanders.com>
...
hi MatchParen   guifg=#e50808   guibg=#520000   gui=bold
...
" Window Elements
hi Exception    guifg=#fb660a
hi StatusLine   guifg=#666666   guibg=#222222
hi StatusLineNC guifg=#333333
hi VertSplit    guifg=#a0b0c0   guibg=#a0b0c0
hi Folded       guifg=#8090a0   guibg=#181818
hi IncSearch    guifg=#708090   guibg=#f0e68c
hi Pmenu        guifg=#ffffff   guibg=#cb2f27
hi SignColumn   guibg=#111111
hi CursorLine   guibg=#181818
hi LineNr       guifg=Gray40    guibg=#222222

hi False        guifg=#e50808   guibg=#520000   gui=bold
hi True         guifg=#08e508   guibg=#005200   gui=bold
...
hi Statement    guifg=#cc0077                   gui=bold
hi Function     guifg=#ff0086                   gui=bold
hi PreProc      guifg=#ff0007                   gui=bold
hi Comment      guifg=Gray40    guibg=#111111   gui=italic
...
hi javaScriptArray              guifg=#777777   guibg=#0808e5
"   000052  
...
hi MyTagListFileName    guifg=#fd8900
hi MyTagListTagName     guifg=Cyan
hi MyTagListTitle       guifg=#cdcaa9   gui=bold,italic
