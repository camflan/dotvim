...
hi def link scptStmt Identifier
...
" --- Constant Boolean ---
syn keyword scptBoolean ask
hi def link scptBoolean Boolean

syn keyword True true yes
syn keyword False false no
...
hi def link scptKeyword pythonExClass
