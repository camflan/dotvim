...
syn keyword True	True
syn keyword False	False
...
if version >= 508 || !exists("did_python_syn_inits")
  ...
  HiLink pythonBuiltin		MoreMsg
  HiLink pythonMethods		Identifier
  HiLink pythonBraces		LineNr
